...
class CreatePetugasPage extends StatefulWidget {
  const CreatePetugasPage({Key? key}) : super(key: key);

  @override
  State<CreatePetugasPage> createState() => _CreatePetugasPageState();
}

class _CreatePetugasPageState extends State<CreatePetugasPage> {
